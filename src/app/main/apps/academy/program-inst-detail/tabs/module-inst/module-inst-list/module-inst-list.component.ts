...
export class ModuleInstListComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this._moduleInstService.onFilterChangedModule
          .pipe(takeUntil(this._unsubscribeAll))
          .subscribe(() => {
          ...
          .subscribe(response => {
              ...
              switch (actionType) {
                  ...
                  case 'save':
                      ...
                      this._moduleInstService.updateModule(formData.getRawValue(),this._moduleInstService.theme);
...
export class FilesDataSource extends DataSource<any>
{
  ...
  connect(): Observable<any[]> {
      return this._moduleInstService.onmoduleChanged;
