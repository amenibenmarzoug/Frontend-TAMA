...
export class ModuleInstComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.searchInput.valueChanges
          ...
          .subscribe(searchText => {
              this._moduleInstService.onSearchTextChangedModule.next(searchText);
          });
  ...
  ngOnDestroy(): void {
      // Reset the search
      this._moduleInstService.onSearchTextChangedModule.next('');
  ...
  addNewModule(): void {
      if ((this._moduleInstService.theme == null)) {
  ...
  confirmAddModule(): void {
      ...
      this.confirmDialogRef.afterClosed().subscribe(result => {
          if (result) {
              ...
              this._moduleInstService.addModule(this.module, this._moduleInstService.theme);
