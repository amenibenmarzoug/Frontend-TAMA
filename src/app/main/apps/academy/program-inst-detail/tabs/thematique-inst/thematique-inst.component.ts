...
export class ThematiqueInstComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      // Subscribe to themes
      this._programInstDetailsService.onThemeChanged
          .pipe(takeUntil(this._unsubscribeAll))
          .subscribe(themes => {
  ...
  newTheme() {
      ...
      this.dialogRef.afterClosed()
          ...
          this._programInstDetailsService.addTheme(response.getRawValue());
      ...
      this.dialogRef.afterClosed()
          .subscribe(response => {
              ...
              switch (actionType) {
                   ...
                   */
                  case 'save':
                      this._programInstDetailsService.updateTheme(formData.getRawValue(),this._programDetailsService.program);
  ...
  deleteTheme(theme): void {
      ...
      this.dialogRef.afterClosed().subscribe(result => {
          if (result) {
              this._programInstDetailsService.deleteTheme(theme);
          }
          this.dialogRef = null;
      });
