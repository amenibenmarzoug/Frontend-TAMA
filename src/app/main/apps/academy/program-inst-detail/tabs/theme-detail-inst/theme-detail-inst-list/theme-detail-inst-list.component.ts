...
export class ThemeDetailInstListComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this._themeDetailsInstService.onThemeDetailChanged
      ...
      this._themeDetailsInstService.onFilterChangedThemeDetail
          .pipe(takeUntil(this._unsubscribeAll))
          .subscribe(() => {
          ...
          .subscribe(response => {
              ...
              switch (actionType) {
                  ...
                  case 'save':
                      ...
                      this._themeDetailsInstService.updateThemeDetail(formData.getRawValue(),this._themeDetailsInstService.module);
...
export class FilesDataSource extends DataSource<any>
{
  ...
  connect(): Observable<any[]> {
      return this._themeDetailsInstService.onThemeDetailChanged;
