...
@Component({
  ...
  styleUrls: ['./edit-trainers-list.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class EditTrainersListComponent implements OnInit, OnDestroy {
   ...
   */
  constructor(
      private _addSessionService: EditSessionService,
