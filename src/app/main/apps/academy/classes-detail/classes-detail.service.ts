...
export class ClassesDetailService {
    ...
    */
    ...
    omitThemeInst(theme): Promise<any> {
        return new Promise((resolve, reject) => {
            const courseIndex = this.themesInst.indexOf(theme.id);
            this.themesInst.splice(courseIndex, 1);
            this.onThemeInstChanged.next(this.themesInst);
            this._httpClient.delete(AUTH_API + `themeInst/omit/${theme.id}`)
                .subscribe(response => {
                    // this.getThemeInst(); 
                    resolve(response);
                });
    ...
    */
    ...
    deleteModule(id): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            this._httpClient.delete(AUTH_API + `moduleInstance/${id}`)
                .subscribe(response => {
                    resolve(response);
                });
        });
    ...
    omitModule(id): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            this.modulesInst.splice(moduleIndex, 1);
            this.onmoduleInstChanged.next(this.modulesInst);
            this._httpClient.delete(AUTH_API + `moduleInstance/omit/${id}`)
                .subscribe(response => {
                    resolve(response);
                });
        });
    ...
    */
    ...
    deleteThemeDetail(id): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            this.onThemeDetailInstChanged.next(this.themeDetailsInst);
            this._httpClient.delete(AUTH_API + `themeDetailInst/${id}`)
                .subscribe(response => {
                    resolve(response);
                });
        });
    ...
    omitThemeDetail(id): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            this.themeDetailsInst.splice(themeDetailIndex, 1);
            this.onThemeDetailInstChanged.next(this.themeDetailsInst);
            this._httpClient.delete(AUTH_API + `themeDetailInst/omit/${id}`)
                .subscribe(response => {
                    resolve(response);
                });
        });
