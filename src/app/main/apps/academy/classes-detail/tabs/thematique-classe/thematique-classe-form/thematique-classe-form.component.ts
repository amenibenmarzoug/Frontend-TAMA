...
import { ThemeInstance} from  'app/shared/models/themeInstance.model';
import { AlertDialogComponent } from '@fuse/components/alert-dialog/alert-dialog/alert-dialog.component';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-thematique-classe-form',
  templateUrl: './thematique-classe-form.component.html',
  styleUrls: ['./thematique-classe-form.component.scss']
})
export class ThematiqueClasseFormComponent implements OnInit {

  action: string;

  themeInst: ThemeInstance;
  ...
  constructor(
    public matDialogRef: MatDialogRef<ThematiqueClasseFormComponent>,
    ...
    if (this.action === 'edit') {
      ...
      this.themeInst = new ThemeInstance({});
