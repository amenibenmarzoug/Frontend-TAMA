...
export class ModulesInstListComponent implements OnInit {
  ...
  this.dataSource = new FilesDataSource(this._moduleInstService2);
      this._moduleInstService2.onmoduleInstChanged
          .pipe(takeUntil(this._unsubscribeAll))
          .subscribe(modules => {
              this.modulInst = modules;
             console.log("moduleeeees");
              console.log(modules);
              console.log("ModuleInstfel claaaaaaaaaaass");
             console.log(this.modulInst);
...
export class FilesDataSource extends DataSource<any>
{
  ...
  connect(): Observable<any[]> {
      ...
      return this._moduleInstService2.onmoduleInstChanged;
