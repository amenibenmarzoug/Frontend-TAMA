...
export class CourseSessionListComponent implements OnInit, OnDestroy {
  ...
  displayedColumns = ['checkbox', 'courseSessionName', 'courseSessionBeginDate', 'courseSessionBeginHour', 'courseSessionEndHour','Course','Institution','Classroom','buttons'];
  ...
  editContact(contact): void
  {
      this.dialogRef = this._matDialog.open(CourseSessionFormComponent, {
          panelClass: 'course-session-form-dialog',
          data      : {
              contact: contact,
              action : 'edit'
          }
