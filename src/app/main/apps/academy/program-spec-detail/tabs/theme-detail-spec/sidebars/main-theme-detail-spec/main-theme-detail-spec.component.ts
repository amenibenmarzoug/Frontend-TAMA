...
@Component({
  selector: 'app-main-theme-detail-spec',
  templateUrl: './main-theme-detail-spec.component.html',
  styleUrls: ['./main-theme-detail-spec.component.scss']
})
export class MainThemeDetailSpecComponent implements OnInit, OnDestroy{
