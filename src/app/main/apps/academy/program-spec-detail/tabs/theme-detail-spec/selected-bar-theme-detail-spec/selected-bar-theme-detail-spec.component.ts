...
@Component({
  selector: 'app-selected-bar-theme-detail-spec',
  templateUrl: './selected-bar-theme-detail-spec.component.html',
  styleUrls: ['./selected-bar-theme-detail-spec.component.scss']
})
export class SelectedBarThemeDetailSpecComponent implements OnInit {
