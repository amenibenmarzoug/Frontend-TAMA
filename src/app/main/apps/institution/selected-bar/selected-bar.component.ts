...
export class SelectedBarComponent implements OnInit, OnDestroy
{
        ...
        this._institutionService.onSelectedContactsChanged
            ...
            .subscribe(selectedContacts => {
                ...
                setTimeout(() => {
                    ...
                    this.isIndeterminate = (selectedContacts.length !== this._institutionService.contacts.length && selectedContacts.length > 0);
                }, 0);
            });
    }
    ...
    selectAll(): void
    {
        this._institutionService.selectContacts();
    }
    ...
    deleteSelectedContacts(): void
    {
        ...
        this.confirmDialogRef.afterClosed()
            .subscribe(result => {
                if ( result )
                {
                    this._institutionService.deleteSelectedContacts();
                }
